...
function preload() {
 ...
 images[0] = loadImage('assets/platform1.png');
...
function setup() {
 ...
 platforms.push(new Platform());
  ...
  coins.push(new Coins(random(20,880), random(20,545), 50,50, images[2]));
 //coins.push(new Coins(width/2, height/2, 50,50, images[2]));
...
//COINS
 ...
 for (i = platforms.length - 1; i >= 0; i--) { // non standard loop, going through the array backwards to splice the platform when it goes offscreen.
  platforms[i].show();
  platforms[i].update();
